...
import com.mycompany.drs.server.ReportService;
import com.mycompany.drs.server.UserService; 
...
public class App extends Application {
    ...
    public void start(Stage stage) throws IOException {
        ...
        userServiceInstance = new com.mycompany.drs.server.UserService(); 
        reportServiceInstance = new com.mycompany.drs.server.ReportService(); // Assuming this package
    ...
    public static ReportService getReportService() {
        if (reportServiceInstance == null) {
            ...
            reportServiceInstance = new com.mycompany.drs.server.ReportService();
        }
    ...
    private static Parent loadFXML(String fxmlBaseName) throws IOException {
        String fxmlPath = "com/mycompany/drs/client/" + fxmlBaseName + ".fxml"; 
